...
// Maaş dizisinden 10000'den büyük olanları filtreleme
const bigThan = salaries.filter((s) => s > 10000);
console.log("10000'den büyük maaşlar:", bigThan, "Orjinal maaşlar:", salaries);

// Maaş dizisinden 6000 ile 10000 arasındakileri filtreleme
const range = salaries.filter((s) => s >= 6000 && s <= 10000);
console.log("6000 ile 10000 arasındaki maaşlar:", range);
